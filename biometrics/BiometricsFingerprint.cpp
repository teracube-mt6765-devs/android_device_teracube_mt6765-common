 ...
 */
#define LOG_TAG "android.hardware.biometrics.fingerprint@2.1-service.emerald"
#define LOG_VERBOSE "android.hardware.biometrics.fingerprint@2.1-service.emerald"
